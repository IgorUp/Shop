...
<head>
    ...
    <title>Каталог коспьютеров</title>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="ups" items="${listTest}" varStatus="status">
                        <tr>
                            ...
                            <td>${ups.cost}</td>
                            <td>
                                <a href="shopping-cart?id_product=${ups.id_product}">Заказать</a> <!--НЕ ЗНАЕМ КАКАЯ ССЫЛКА!!!!ТУТ ПЕРЕНОС ДАННЫХ В ТАБЛИЦУ КОРЗИНА.ЕСЛИ ЮЗЕР НЕ ЗАРЕГАННЫЙ.ТО ПУСТЬ ВЫЛАЗИТ АЛЕРТ.НУ ИЛИ САМ ЧТО-НИБУДЬ ПРИДУМАЙ-->
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
